...
{
val V = "2.0.4"
val modules = Seq("anorm","console","play-test","play") //,"templates")
seq(
libraryDependencies += "play" %% "templates" % V
,
...
(sourceGenerators in Compile) <+= (scalaVersion) map{
  S =>
  val playRepo = "http://repo.typesafe.com/typesafe/maven-releases/play/"
